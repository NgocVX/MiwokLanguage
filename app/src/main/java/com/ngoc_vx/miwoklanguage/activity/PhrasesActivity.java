    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                //Toast.makeText(PhrasesActivity.this, "Clicked item list numbers", Toast.LENGTH_SHORT).show();
                mediaPlayer = MediaPlayer.create(PhrasesActivity.this, phrases.get(position).getAudioResourceId());
                mediaPlayer.start();
            }
        });
    }
